...
const httpMiddlewares = [
  ...
  ['oauth2_resource', '/reference/server/http/middlewares/oauth2_resource'],
  ...
  ['telemetry', '/reference/server/http/middlewares/telemetry'],
                ...
                items: [
                  {
                    ...
                    collapsed: true,
                    items: [
                      { text: 'bandwidth_limit', link: '/reference/server/tcp/middlewares/bandwidth_limit' },
                      { text: 'conn_limit', link: '/reference/server/tcp/middlewares/conn_limit' },
                      { text: 'http_connect', link: '/reference/server/tcp/middlewares/http_connect' },
                      { text: 'idle_timeout', link: '/reference/server/tcp/middlewares/idle_timeout' },
                      { text: 'ip_allow_list', link: '/reference/server/tcp/middlewares/ip_allow_list' },
                      { text: 'ip_deny_list', link: '/reference/server/tcp/middlewares/ip_deny_list' },
                      { text: 'load_balancer', link: '/reference/server/tcp/middlewares/load_balancer' },
                      { text: 'log', link: '/reference/server/tcp/middlewares/log' },
                      { text: 'proxy_protocol', link: '/reference/server/tcp/middlewares/proxy_protocol' },
                      { text: 'rate_limit', link: '/reference/server/tcp/middlewares/rate_limit' },
                      { text: 'redirect', link: '/reference/server/tcp/middlewares/redirect' },
                      { text: 'sni_router', link: '/reference/server/tcp/middlewares/sni_router' },
                      { text: 'socks5', link: '/reference/server/tcp/middlewares/socks5' },
                      { text: 'telemetry', link: '/reference/server/tcp/middlewares/telemetry' },
                      { text: 'tls_terminate', link: '/reference/server/tcp/middlewares/tls_terminate' },
                    ],
                  },
                ],
              },
                ...
                items: [
                  {
                    ...
                    items: [
                      ...
                      { text: 'ip_deny_list', link: '/reference/server/udp/middlewares/ip_deny_list' },
                      { text: 'load_balancer', link: '/reference/server/udp/middlewares/load_balancer' },
                      { text: 'log', link: '/reference/server/udp/middlewares/log' },
                      { text: 'mirror', link: '/reference/server/udp/middlewares/mirror' },
                      { text: 'rate_limit', link: '/reference/server/udp/middlewares/rate_limit' },
                      { text: 'redirect', link: '/reference/server/udp/middlewares/redirect' },
                      { text: 'telemetry', link: '/reference/server/udp/middlewares/telemetry' },
                    ],
                  },
                ],
              },
